package com.businessdomain.catalog.exceptions.common;


import io.swagger.v3.oas.annotations.media.Schema;

@Schema(description = "Standardized error response based on RFC 7807")
public class StandardizeApiExceptionResponse {
    ...
    public StandardizeApiExceptionResponse(String code, String detail, String instance, String title, String type) {
        this.code = code;
        this.detail = detail;
    ...
    public StandardizeApiExceptionResponse (){}
