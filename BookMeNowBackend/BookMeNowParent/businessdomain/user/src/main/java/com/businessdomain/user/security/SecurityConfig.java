package com.businessdomain.user.security;
import com.businessdomain.user.common.JwtAuthenticationFilter;
 ...
 * It registers the security filter chain, authentication manager,
 * and password encoder beans.
 */
@Configuration
@EnableWebSecurity
